...
const SALLY_SALES_OS = [
  ...
  '- Phone speech: thick common Cockney + banter (see VOICE block). Never warm-professional RP or “clear English”. Chat replies can be a bit longer.',
...
export function buildSallyWebPrompt(input?: {
  ...
  return [
    ...
    'AIM: Answer like their search engine for Sync2Dine — common UK English with cheek, not stiff RP. Guide toward Atmosphere pricing, then call or enquire.',
