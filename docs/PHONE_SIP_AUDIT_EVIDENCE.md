# Phone / SIP full audit — evidence table
...
| C12 | Vapi BYO both DIDs on cred `bf62dc42…`, serverUrl webhook | PASS | `vapi-ensure-byo.mjs` both `already provisioned` |
...
| E18 | extract registries show new routes | PASS* | `ai-set`, `sync-asterisk-bridge`, `sally-offer` in `routes-discovered.json`; `check:agent-maps` fingerprint drift includes unrelated WIP — baseline deferred |

## Live AI line set (post-audit)

| Role | Org | SIP user | DID | E.164 | Asterisk | Stored status |
|------|-----|----------|-----|-------|----------|---------------|
| Sally | home `4fc49703-…` | `1005090093` | `02037453233` | `+442037453233` | Registered | registered |
| Judie | demo kitchen `c2887ddb-…` | `1014090093` | `02071128727` | `+442071128727` | Registered | registered |
...
- **Human PSTN (C13):** not dialed this session — call both DIDs to confirm greeting audio.
